...
set.seed(321)
model.tuned <- iClusterPlus::tune.iClusterBayes(cpus = 5,
...
model.test <- iClusterPlus::iClusterBayes(cpus = 5,
                                          dt1 = gene$matrix[-train_id, ],
                                          dt2 = seg.cn[-train_id, ],
                                          dt3 = meth450$matrix[-train_id, ],
                                          type = c("gaussian","gaussian", "gaussian"),
...
#-------------------
metrics_list <- get_survmetrics(train = x, test = x_test, cox_rp = cox_rp, 
                            cox_rp_train = cox_rp_train)
